 ...
 */
class PagedGalleryAdapter(private val context: Context) :
    PagedListAdapter<GridItem, PagedGalleryAdapter.GalleryViewHolder>(GalleryDiffCallback()) {
